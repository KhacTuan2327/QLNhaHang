...
namespace QLNhaHang.Staff
{
    public partial class RegisterForm : Form
    {
        ...
        private void txtAddManv_TextChanged(object sender, EventArgs e)
        {
            sqlCon.Close();
            sqlCon.Open();
        ...
        private void txtAddChucvu_TextChanged(object sender, EventArgs e)
        {
        ...
        private void txtAddChucvu_Validating(object sender, CancelEventArgs e)
        {
